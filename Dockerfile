...
#   - Ex: docker.io/hexpm/elixir:1.18.3-erlang-27.3.3-debian-trixie-20260223-slim
#
...
# Copy the entire phoenix_prerender library (parent directory)
COPY mix.exs mix.lock ./
COPY lib lib/

# Now copy the demo app
COPY demo/mix.exs demo/mix.lock demo/
WORKDIR /app/demo

# install mix dependencies for demo app
